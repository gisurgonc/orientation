...
Please use Haiku for messaging service attendings rather than text. Please check our status prior to messaging nights and weekends. If we are listed as unavailable, please contact *GI Surg Onc Attending LCI CMC*.
...
If the service workload jeopardizes your ability to abide by the work hour restrictions, you must notify an attending so that arrangements can be made. The service attendings are committed to abiding by work hour restrictions. Service residents are *not* expected to cover late cases (after 6pm)
