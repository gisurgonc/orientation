...
MSKCC trial of neoadjuvant PD-1 blockade with dostarlimab for 12 patients with MMR-deficient (MSI-high) rectal cancer resulted in 100\% clinical response rate \citep{cercek2363}. No patients were subsequently treated with either chemoradiation or surgery as originally planned.

PICC trial \citep{hu38} Chinese trial of PD-1 blockade with neoadjvant toripalimab + colecoxib vs toripalimab in 34 patients with MMR-deficient locally-advanced (T3/4 or N+) colorectal cancer. Pathologic complete response in 88\% of dual-therapy patients and 65\% in monotherapy. Grade 3 toxicity in 1/34 patients.
