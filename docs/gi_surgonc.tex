...
In general Dr Kasten will round on his own patients at CMC. Dr Davis will round on his patients on days when he is at CMC.
...
CLAASIC trial \citep{noh1389} \citep{bang315} \citep{noh1389} patients with II or IIIB gastric cancer received gastrectomy with D2 node dissection randomized to postoperative chemotherapy with capecitabine and oxaliplatin. Chemotherapy group had improved 3-year DFS (74\% vs 59\% P\textless.0001)
...
\hypertarget{rectal-cancer-surgery-1}{%
\chapter{Rectal Cancer Surgery}\label{rectal-cancer-surgery-1}}
...
\hypertarget{surgery-rightarrow-radiation}{%
\section{\texorpdfstring{Surgery \(\Rightarrow\) Radiation}{Surgery \textbackslash Rightarrow Radiation}}\label{surgery-rightarrow-radiation}}

The original approach to adjuvant therapy for rectal cancer was surgery followed by chemoradiation.

\hypertarget{radiation-rightarrow-surgery}{%
\section{\texorpdfstring{Radiation \(\Rightarrow\) Surgery}{Radiation \textbackslash Rightarrow Surgery}}\label{radiation-rightarrow-surgery}}
...
\section{Short-course preoperative therapy}\label{short-course-preoperative-therapy}}
...
\section{Total Neoadjuvant therapy}\label{total-neoadjuvant-therapy}}
...
\hypertarget{selective-adjuvant-therapy}{%
\section{Selective adjuvant therapy}\label{selective-adjuvant-therapy}}
