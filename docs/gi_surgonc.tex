...
\item
  Orvil 21mm
\item
  Eschelon 60mm stapler with 10 gold loads and 2 gray loads
\item
  Gel Port
\end{itemize}
...
Higher lymph node yield with MIE vs open approach \citep{kalff}
...
MSKCC published an experience of 113 patients with cCR after chemoradiation for rectal cancer who elected non-operative management \citep{smithe185896}. Among this group, 22 developped a local recurrence, and 8\% developed metastatic disease.\citep{smith657}
