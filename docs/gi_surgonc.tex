...
\textbf{January 2022} Due to transitions in Dr Hill's clinic staffing, please send messages for discharges directly to him, and he will forward.
...
\hypertarget{resident-halo-teams-1}{%
\section{Resident Halo teams:}\label{resident-halo-teams-1}}
...
\hypertarget{attending-halo-teams-1}{%
\section{Attending Halo teams:}\label{attending-halo-teams-1}}
...
\hypertarget{weaning-tube-feeds}{%
\section{Weaning Tube Feeds}\label{weaning-tube-feeds}}
...
Jejunostomy feedings carry a small but significant risk (\textasciitilde1\%) of small bowel necrosis, as evidenced by the findings of pneumatosis on CT scan and in some cases small bowel necrosis and perforation. The existing literature would suggest that the early symptoms associated with small bowel necrosis are abdominal distension. As a result, patients on jejunostomy tube feeding need to be carefully monitored for distension, and tube feeds held if distension develops.\hspace{0pt}1\hspace{0pt} Tube feeds are generally started at 30mL/hour in the immediate postoperative patients. In patients who are awake and in whom it is possible to determine whether or not there are issues of tube feed intolerance, the rate of tube feedings is increased 10mL/hour every 8 hours to a goal of 60mL/hour. In patients who are intubated/sedated, the advancement of tube feeds is individualized, and decisions are made on a daily basis on rounds.

Choice of Tube Feed Formula

Options for formulas for jejunostomy feedings:

Osmolite 1.5: First-line formula for BMI \textless35
...
Vital 1.5: Second-line formula (intolerant of Osmolite) for BMI\textless35
...
Promote: First-line formula for BMI \textgreater35 or diabetics
...
Vital High Protein: Second-line formula for BMI \textgreater35
...
\hypertarget{weaning-tube-feeds-1}{%
\section{Weaning Tube Feeds}\label{weaning-tube-feeds-1}}
...
MERCURY group trial of predictive value of MRI for rectal cancer\citep{taylor34}
