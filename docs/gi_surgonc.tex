...
Please use Haiku for messaging service attendings rather than SMS. Please check our status prior to messaging nights and weekends. If we are listed as unavailable, please contact \emph{GI Surg Onc Attending LCI CMC}.
...
In general Dr Kasten will round on his own patients at CMC. Dr Davis will round on his patients on Wednesdays if he has cases at CMC.
...
Starting time for rounds is variable from day to day. Dr Kasten will round on his own patients.
...
Each of the patients problems are addressed with an assessment and plan. Pre-existing medical problems and postoperative complications need to be addressed in the plan. An assessment and plan for each organ system is usually not necessary, except for the most complex patients.
...
Each day, the event of the hospitalization is carried from note to note. Each day, an additional line is added to the progress note which summarizes events for that day. This makes it possible to see within each Progress Note the pertinent events for the hospitalization. These events would include extubation, re-intubation, positive cultures, dates lines are inserted or removed, dates of removal of NG tubes and drains, and transfer to ward or re-admission to ICU. This chronology assists in treatment decisions (``how old is the IJ line'' or ``when did we start antibiotics?'' or ``when is the planned antibiotic stop date''?) but also makes the discharge summary much easier to prepare.

\textbf{Assessment/Plan}
...
\chapter{CV Port (IJ) - Salo}\label{cv_port_salo}}
...
\chapter{Lap Gastrostomy - Salo}\label{lap_gastrostomy_salo}}
...
\chapter{Objectives - JR}\label{EsoObjJB}}

\href{https://www.surgicalcore.org/modulecontent.aspx?id=1000534}{Junior Resident CORE - Esophageal Neoplasms}
\href{https://www.surgicalcore.org/modulecontent.aspx?id=164703}{Junior Resident CORE - Esophagectomy}

\hypertarget{anatomy}{%
\section{Anatomy}\label{anatomy}}

\hypertarget{epidemiology-and-prevention}{%
\section{Epidemiology and Prevention}\label{epidemiology-and-prevention}}
...
\hypertarget{diagnosis-and-staging}{%
...
\hypertarget{operative-treatment}{%
\section{Operative Treatment}\label{operative-treatment}}
...
\hypertarget{intraop-decision-making}{%
\section{Intraop Decision-making}\label{intraop-decision-making}}
...
\hypertarget{nonoperative-management}{%
\section{Nonoperative management}\label{nonoperative-management}}
...
\chapter{Objectives - Chief}\label{EsoObjCR}}

\href{https://www.surgicalcore.org/modulecontent.aspx?id=1000690}{Chief Resident CORE}

\hypertarget{epidemiology-and-prevention-1}{%
\section{Epidemiology and Prevention}\label{epidemiology-and-prevention-1}}
...
\hypertarget{diagnosis-and-staging-1}{%
\section{Diagnosis and Staging}\label{diagnosis-and-staging-1}}
...
\hypertarget{multidisicplinary-management}{%
\section{Multidisicplinary Management}\label{multidisicplinary-management}}
...
\hypertarget{operative-mangement}{%
\section{Operative Mangement}\label{operative-mangement}}
...
\section{Anatomy}\label{anatomy-1}}
...
\hypertarget{diagnosis-and-staging-2}{%
\section{Diagnosis and Staging}\label{diagnosis-and-staging-2}}
...
\hypertarget{operative-treatment-1}{%
\section{Operative Treatment}\label{operative-treatment-1}}
...
\hypertarget{non-operative-treatments}{%
\section{Non-operative Treatments}\label{non-operative-treatments}}
...
\hypertarget{preoperative-preparation}{%
\section{Preoperative Preparation}\label{preoperative-preparation}}

\hypertarget{operative-details}{%
\section{Operative Details}\label{operative-details}}
...
\section{GI stromal tumors}\label{gi-stromal-tumors}}
...
\hypertarget{gastric-carciniods}{%
\section{Gastric carciniods}\label{gastric-carciniods}}
...
\hypertarget{gastric-lymphoma}{%
\section{Gastric lymphoma}\label{gastric-lymphoma}}
...
\hypertarget{gastric-polyps}{%
\section{Gastric Polyps}\label{gastric-polyps}}
...
\chapter{Objectives - Colon CA}\label{ColonObjCR}}

\href{https://www.surgicalcore.org/modulecontent.aspx?id=1000690}{Colon Cancer CORE}

\hypertarget{physiology}{%
\section{Physiology}\label{physiology}}
...
\hypertarget{hereditary-syndromes}{%
\section{Hereditary Syndromes}\label{hereditary-syndromes}}
...
\hypertarget{screening-for-average-risk}{%
\subsection{Screening for average risk}\label{screening-for-average-risk}}

\hypertarget{screening-for-elevated-risk}{%
\subsection{Screening for elevated risk}\label{screening-for-elevated-risk}}

\hypertarget{endoscopy}{%
\section{Endoscopy}\label{endoscopy}}
...
\hypertarget{operative-treatment-2}{%
\section{Operative Treatment}\label{operative-treatment-2}}
...
\chapter{Objectives - Colectomy}\label{PColectomyObj}}
...
\hypertarget{operative-anatomy-1}{%
\section{Operative Anatomy}\label{operative-anatomy-1}}
...
\section{Complications}\label{complications-2}}
...
\chapter{Objectives - Colostomy}\label{ColostomyObj}}
...
\hypertarget{preop-prep-1}{%
\section{Preop Prep}\label{preop-prep-1}}
...
\hypertarget{operative-anatomy-2}{%
\section{Operative Anatomy}\label{operative-anatomy-2}}

\hypertarget{intraop-decision-making-1}{%
\section{Intraop Decision-making}\label{intraop-decision-making-1}}

\hypertarget{TColectomyObj}{%
\chapter{Objectives - Total Colectomy}\label{TColectomyObj}}

\href{https://www.surgicalcore.org/modulecontent.aspx?id=1000583}{Total Colectomy CORE}

\hypertarget{indications-3}{%
\section{Indications}\label{indications-3}}
...
\hypertarget{operative-anatomy-3}{%
\section{Operative Anatomy}\label{operative-anatomy-3}}

\hypertarget{intraop-decision-making-2}{%
\section{Intraop Decision-making}\label{intraop-decision-making-2}}
...
\hypertarget{rectal-objectives}{%
\chapter{Rectal Objectives}\label{rectal-objectives}}

\href{https://www.surgicalcore.org/modulecontent.aspx?id=130244}{Rectal CA SCORE}

\hypertarget{anatomy-2}{%
\section{Anatomy}\label{anatomy-2}}
...
\hypertarget{operative-treatment-3}{%
\section{Operative Treatment}\label{operative-treatment-3}}
...
\hypertarget{isolated-liver-metastasis}{%
\subsection{Isolated liver metastasis}\label{isolated-liver-metastasis}}

\hypertarget{adjuvant-therapy-1}{%
\section{Adjuvant therapy}\label{adjuvant-therapy-1}}
...
\hypertarget{indications-4}{%
\section{Indications}\label{indications-4}}

-Contraindications

\hypertarget{operative-anatomy-4}{%
\section{Operative Anatomy}\label{operative-anatomy-4}}

\hypertarget{preop-prep-2}{%
\section{Preop Prep}\label{preop-prep-2}}
