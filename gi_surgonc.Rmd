...
Please append a text block to the bottom of each progress note specifying the Epic Team *GI Surgical Oncology LCI CMC* for that patient to facilitate communication from nursing.
...
# Lap Gastrostomy - Salo {#lap_gastrostomy_salo}
